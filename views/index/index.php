            ...
            <div class="col-xs-12 col-md-5 no-margin">
                <div class="product-item-holder size-big single-product-gallery small-gallery">
                    ...
                    <div class="gallery-thumbs clearfix">
                        ...
                        <?php foreach ((array)json_decode($last->pics, true) as $key => $pic): ?>
                            <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider" data-slide="<?php echo $key; ?>" href="#slide<?php echo $key; ?>"><img alt="" src="http://<?php echo $pic ?>" data-echo="http://<?php echo $pic ?>" /></a></li>
                        <?php endforeach; ?>
                        </ul>
                    </div><!-- /.gallery-thumbs -->
